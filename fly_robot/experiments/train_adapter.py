"""Train the adapter with CMA-ES. The connectome is never trained.
...
Usage:
    MUJOCO_GL=cgl PYTHONPATH=$PWD .venv/bin/python \
        -m fly_robot.experiments.train_adapter --generations 250
...
def main():
    ...
    cfg = TrainConfig(
        ...
        shuffle_seed=shuffle_seed, out_dir=args.out_dir,
    )
